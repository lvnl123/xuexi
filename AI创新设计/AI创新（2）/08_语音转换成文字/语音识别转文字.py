...
def fileTrans(akId, akSecret, appKey, fileLink) :
    ...
    if statusText == STATUS_SUCCESS :
        ...
        print ("录音文件识别失败！")
    return
accessKeyId = ('LTAI5tBtM4nJaWuQy8krAD88')
accessKeySecret = ('SZ7XGPfuRzqnKnMEgpOWhF9LaweAOS')
appKey = ('sx3HwgCsOODW28Vb')
fileLink = "https://esp32yuyin.oss-cn-hangzhou.aliyuncs.com/example.mp3"
# 执行录音文件识别
