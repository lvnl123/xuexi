...
plt.savefig(os.path.join(output_dir, '06线性回归2图'))
...
plt.savefig(os.path.join(output_dir, '07K近邻回归图'))
...
plt.savefig(os.path.join(output_dir, '08决策树回归图'))
...
myGBR = GradientBoostingRegressor(
    ...
    max_features='sqrt',
    max_leaf_nodes=None,
    min_impurity_decrease=0.0,  # ✅ 替代 min_impurity_split
    min_samples_leaf=10,
